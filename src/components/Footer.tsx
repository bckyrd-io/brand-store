              ...
              <div className="space-y-6 text-lg ">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p>[Your Farm Address]</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-2xl">🏡</span>
                  <div>
                    <h4 className="font-semibold">Town Lodge</h4>
                    <p>[Your Lodge Address]</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <span className="text-2xl">⏰</span>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p>For Bookings: [Your Phone Number]</p>
                  </div>
                </div>
              </div>
              <div className="flex gap-6 mt-8">
                <Link href="https://tiktok.com/@groundfarm" className=" hover:text-dark">
                ...
                <Link href="https://instagram.com/groundfarm" className=" hover:text-dark">
                ...
                <Link href="https://facebook.com/groundfarm" className=" hover:text-dark">
                  <span className="sr-only">Facebook</span>
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                </Link>
                <Link href="https://wa.me/yournumber" className=" hover:text-dark">
